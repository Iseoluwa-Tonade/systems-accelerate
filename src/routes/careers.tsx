...
const ROLES = [
  {
    ...
    location: "Remote",
    color: "#8B5CF6",
    desc: "Work with B2B clients to implement HubSpot or Salesforce, design clean pipelines, and build reporting dashboards that leadership can trust.",
    requirements: [
      "2+ years in a RevOps, CRM admin, or sales operations role",
      "Hands-on with HubSpot or Salesforce (implementation, not just usage)",
  ...
  },
  {
    ...
    location: "Remote",
    color: "#FFB800",
    desc: "Support day-to-day back-office operations for SuperTelque clients. Tasks span admin, order management, inbox management, data entry, and scheduling.",
    requirements: [
      "Prior experience as a VA, admin assistant, or in a back-office role",
      "Highly organised with strong attention to detail",
      "Fluent in written English",
      "Comfortable with Google Workspace and basic CRM or project management tools",
    ],
  },
] as const;
