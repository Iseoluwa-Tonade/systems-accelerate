...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SuperTelque architects RevOps, GTM automation, CRM and AI-powered revenue systems for B2B companies globally." },
      { name: "author", content: "SuperTelque" },
      { property: "og:title", content: "SuperTelque | Revenue Systems Engineered for Scale" },
      { property: "og:description", content: "SuperTelque architects RevOps, GTM automation, CRM and AI-powered revenue systems for B2B companies globally." },
