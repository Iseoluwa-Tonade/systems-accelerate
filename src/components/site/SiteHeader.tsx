        ...
        <div className="flex items-center gap-2">
          <div className="hidden md:flex items-center gap-2">
            ...
            <a
              ...
              className={`inline-flex items-center gap-1.5 rounded-full px-3.5 py-2 text-[12px] font-medium border transition-all duration-200 active:scale-95 ${
                dark
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="mt-3 flex flex-col gap-2">
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setOpen(false)}
                className={`inline-flex items-center justify-center gap-1.5 rounded-full border px-4 py-2.5 text-sm font-medium active:scale-95 transition ${
                  dark
              ...
              <Link
                to="/book"
                onClick={() => setOpen(false)}
                className={`inline-flex items-center justify-center gap-1.5 rounded-full px-4 py-2.5 text-sm font-bold active:scale-95 transition ${
                  dark
                    ? "text-[#080D1C]"
                    : "bg-[#080D1C] text-white hover:opacity-90"
                }`}
