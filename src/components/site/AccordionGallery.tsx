...
const DEFAULT_ITEMS: AccordionGalleryItem[] = [
  { image: "/diagnose.png", label: "Diagnose", alt: "Diagnose" },
  { image: "/design.png", label: "Design", alt: "Design" },
  { image: "/build.png", label: "Build", alt: "Build" },
  { image: "/operate.png", label: "Operate", alt: "Operate" },
  { image: "/improve.png", label: "Improve", alt: "Improve" },
];
...
const AccordionGallery = ({
  ...
  const handleClick = (i: number, e: { preventDefault: () => void }) => {
    if (i !== active) {
      e.preventDefault();
      setActive(i);
    }
